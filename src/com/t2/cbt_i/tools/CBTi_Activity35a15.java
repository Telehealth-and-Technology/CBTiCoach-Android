...
public class CBTi_Activity35a15 extends CBTi_BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((TextView)findViewById(R.id.tvTopTitle)).setText( R.string.s_cloudsinthesky);
		...
		((ImageButton)findViewById(R.id.ibTopLeft)).setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {		// handle the about button
				...
				Intent i = new Intent(CBTi_Activity35a15.this, DashActivity.class );
