...
public class QuiteMindObserveSensationsContentActivity extends BaseABSNHActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if( iRid == R.id.bSelfGuided ) {
			setContentView(R.layout.tools_quitemindobservesensations_selfguided);
			((TextView)findViewById(R.id.tvSelf)).setMovementMethod(new ScrollingMovementMethod());
		} else {
			setContentView(R.layout.tools_quitemindobservesensations_audioguided);
	...
	public void onBackPressed() {
		...
		QuiteMindObserveSensationsContentActivity.this.overridePendingTransition( R.anim.slide_right, R.anim.slide_right2);
	}
