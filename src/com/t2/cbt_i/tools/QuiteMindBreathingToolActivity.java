...
public class QuiteMindBreathingToolActivity extends BaseABSActivity {

	private int[] iCaptionId = 		{ 
			R.string.s_btool01, R.string.s_btool02, R.string.s_btool03, R.string.s_btool04, R.string.s_btool05,
			R.string.s_btool06, R.string.s_btool07, R.string.s_btool08, R.string.s_btool09, R.string.s_btool10,
			R.string.s_btool11, R.string.s_btool12, R.string.s_btool13, R.string.s_btool14, R.string.s_btool15,
			R.string.s_btool16, R.string.s_btool17, R.string.s_btool18, R.string.s_btool19, R.string.s_btool20,
			R.string.s_btool21, R.string.s_btool22, R.string.s_btool23, R.string.s_btool24, R.string.s_btool25,
			R.string.s_btool26, R.string.s_btool27, R.string.s_btool28, R.string.s_btool29, R.string.s_btool30,
			R.string.s_btool31, R.string.s_btool32, R.string.s_btool33, R.string.s_btool34, R.string.s_btool35,
			R.string.s_btool36, R.string.s_btool37, R.string.s_btool38, R.string.s_btool39, R.string.s_btool40,
			R.string.s_btool41, R.string.s_btool42, R.string.s_btool43, R.string.s_btool44, R.string.s_btool45,
			R.string.s_btool46, R.string.s_btool47, R.string.s_btool48, R.string.s_btool49, R.string.s_btool50,
			R.string.s_btool51, R.string.s_btool52, R.string.s_btool53, R.string.s_btool54, R.string.s_btool55,
			R.string.s_btool56, R.string.s_btool57, R.string.s_btool58, R.string.s_btool59, R.string.s_btool60,
			R.string.s_btool61, R.string.s_btool62, R.string.s_btool63, R.string.s_btool64, R.string.s_btool65,
			R.string.s_btool66, R.string.s_btool67 };
	private int[] iCaptionStart = 	{ 
			1, 10, 18, 32, 38, 43, 51, 57, 59, 66, 72, 75, 77, 84, 92, 98, 105, 113, 117, 120,
			127, 132, 135, 138, 141, 145, 148, 151, 155, 160, 162, 166, 170, 173, 176, 180, 182, 187, 190, 194,
			197, 202, 204, 208, 211, 216, 218, 223, 225, 230, 233, 236, 239, 244, 246, 250, 253, 261, 266, 272, 
			275, 278, 281, 287, 292, 295, 296 };
	
	private int[] iCaptionId2 = 		{ 	R.string.s_One, 	R.string.s_Relax,
											R.string.s_Two, 	R.string.s_Relax,
											R.string.s_Three, 	R.string.s_Relax,
											R.string.s_Four, 	R.string.s_Relax,
											R.string.s_Five, 	R.string.s_Relax,
											R.string.s_Six, 	R.string.s_Relax,
											R.string.s_Seven, 	R.string.s_Relax,
											R.string.s_Eight, 	R.string.s_Relax,
											R.string.s_Eight, 	R.string.s_Relax,
											R.string.s_Seven, 	R.string.s_Relax,
											R.string.s_Six, 	R.string.s_Relax,
											R.string.s_Five, 	R.string.s_Relax,
											...
											R.string.s_Three, 	R.string.s_Relax,
											R.string.s_Two, 	R.string.s_Relax };
	private int[] iCaptionStart2 = 	{ 	73,  77, 
										87,  93,
										100, 106, 
										115, 121,
										130, 135,
	...
	private int[] iResIdStart =	{ 	43, 49, 51, 
									59, 64, 66, 
									71, 75, 77, 
									84, 90, 92, 
									97, 103, 105, 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tools_quitemindbreathingtool);
		
		iImageOverlay 	= (ImageView)findViewById( R.id.iImageOverlay );
		iImage    		= (ImageView)findViewById(R.id.iImage);
		tCaption  		= (TextView)findViewById(R.id.caption);
		tCaption2 		= (TextView)findViewById(R.id.caption2);
		bPlayMe   		= (Button)findViewById(R.id.bPlayMe);
		...
		Uri uUri = Uri.parse( "android.resource://" + getPackageName() + "/" + R.raw.mp3_deepbreathing );
	...
	public void onBackPressed() {
		...
		QuiteMindBreathingToolActivity.this.overridePendingTransition( R.anim.slide_right, R.anim.slide_right2);
	}
	...
	private Runnable rSequencer = new Runnable() {	//Do something to the UI thread here
		@Override 
	    public void run() {		//This method runs in the same thread as the UI. 
			...
			if( iVideoCur > 0 ) {
				...
				if( (iCur2!=-1) && (iResLast2!=iCur2) ) {
					...
					fadeOutt.setInterpolator(new AccelerateInterpolator()); // and this
	...
	public void getHelp() {			// called to render help screen
		Intent i = new Intent(QuiteMindBreathingToolActivity.this, CBTi_Help.class );
		i.putExtra("RID_Img",  R.drawable.buddy_toolsbreathingtool);
		i.putExtra("RID_Text", R.string.s_35a10help);
		QuiteMindBreathingToolActivity.this.startActivity(i);
		QuiteMindBreathingToolActivity.this.overridePendingTransition( R.anim.slide_up, R.anim.slide_up2);
	}
}
