...
public class QuiteMindCountryRoadImageryActivity extends BaseABSActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tools_quitemindcountryroadimagery);
	...
	public void onBackPressed() {
		...
		iVideoPos = 0;
		QuiteMindCountryRoadImageryActivity.this.overridePendingTransition( R.anim.slide_right, R.anim.slide_right2);
	}
	...
	public void getHelp() {			// called to render help screen
		Intent i = new Intent(QuiteMindCountryRoadImageryActivity.this, CBTi_Help.class );
		i.putExtra("RID_Img",  R.drawable.guidedimageryroad);
		i.putExtra("RID_Text", R.string.s_35a12help);
		QuiteMindCountryRoadImageryActivity.this.startActivity(i);
		QuiteMindCountryRoadImageryActivity.this.overridePendingTransition( R.anim.slide_up, R.anim.slide_up2);
	}
}
