...
public class QuiteMindScheduleWorryTimeActivity extends BaseABSActivity {	
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tools_quitemindscheduleworrytime);
	...
	public void onBackPressed() {
		super.onBackPressed();
		QuiteMindScheduleWorryTimeActivity.this.overridePendingTransition( R.anim.slide_right, R.anim.slide_right2);
	}
	...
	public void getHelp() {			// called to render help screen
		Intent i = new Intent(QuiteMindScheduleWorryTimeActivity.this, CBTi_Help.class );
		i.putExtra("RID_Img",  R.drawable.buddy_toolsworrytime);
		i.putExtra("RID_Text", R.string.s_35dhelp);
		QuiteMindScheduleWorryTimeActivity.this.startActivity(i);
		QuiteMindScheduleWorryTimeActivity.this.overridePendingTransition( R.anim.slide_up, R.anim.slide_up2);
	}
}
