...
public class QuiteMindObserveThoughtsContentActivity extends BaseABSNHActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if( iRid == R.id.bSelfGuided ) {
			setContentView(R.layout.tools_quitemindobservethoughts_selfguided);
			((TextView)findViewById(R.id.tvSelf)).setMovementMethod(new ScrollingMovementMethod());
		} else {
			setContentView(R.layout.tools_quitemindobservethoughts_audioguided);
	...
	public void onBackPressed() {
		...
		QuiteMindObserveThoughtsContentActivity.this.overridePendingTransition( R.anim.slide_right, R.anim.slide_right2);
	}
