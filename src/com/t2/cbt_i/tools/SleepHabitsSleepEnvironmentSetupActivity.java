...
public class SleepHabitsSleepEnvironmentSetupActivity extends BaseABSActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tools_sleephabitssleepenvironmentsetup);
	...
	public void onBackPressed() {
		...
		super.onBackPressed();
		SleepHabitsSleepEnvironmentSetupActivity.this.overridePendingTransition( R.anim.slide_right, R.anim.slide_right2);
	}
