...
public class QuiteMindProgressiveMuscleRelaxationActivity extends BaseABSActivity {
	...
	private void videoPlay() {
		setContentView(R.layout.tools_quitemindprogressivemusclerelaxationvideoplaying);
		setup();
	...
	public void onBackPressed() {
		...
		iVideoPos = 0;
		QuiteMindProgressiveMuscleRelaxationActivity.this.overridePendingTransition( R.anim.slide_right, R.anim.slide_right2);
	}
	...
	public void getHelp() {			// called to render help screen
		Intent i = new Intent(QuiteMindProgressiveMuscleRelaxationActivity.this, CBTi_Help.class );
		i.putExtra("RID_Img",  R.drawable.buddy_toolsprogressivemusclerelaxation);
		i.putExtra("RID_Text", R.string.s_35a11help);
		QuiteMindProgressiveMuscleRelaxationActivity.this.startActivity(i);
		QuiteMindProgressiveMuscleRelaxationActivity.this.overridePendingTransition( R.anim.slide_up, R.anim.slide_up2);
	}
}
