...
public class SleepHabitsGetOutOfBedOnTimeActivity extends BaseABSActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tools_sleephabitsgetoutofbedontime);
		
		((CheckBox)findViewById(R.id.cbGetOut01)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut02)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut03)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut04)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut05)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut06)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut07)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut08)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut09)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut10)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut11)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut12)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut13)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut14)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut15)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut16)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut17)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut18)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut19)).setOnClickListener( GetOutOCL );
		((CheckBox)findViewById(R.id.cbGetOut20)).setOnClickListener( GetOutOCL );	
	}	
	...
	public void onBackPressed() {
		super.onBackPressed();
		SleepHabitsGetOutOfBedOnTimeActivity.this.overridePendingTransition( R.anim.slide_right, R.anim.slide_right2);
	}
	...
	protected void onResume() {
		cData34c2 = new SleepHabitsGetOutOfBedOnTimeData(this);
		cData34c2.renderData();
		super.onResume();
	}
	...
	public void getHelp() {			// called to render help screen
		Intent i = new Intent(SleepHabitsGetOutOfBedOnTimeActivity.this, CBTi_Help.class );
		i.putExtra("RID_Img",  R.drawable.buddy_toolsgetoutofbedatyourprescribedbedtime);
		i.putExtra("RID_Text", R.string.s_34e2);
		SleepHabitsGetOutOfBedOnTimeActivity.this.startActivity(i);
		SleepHabitsGetOutOfBedOnTimeActivity.this.overridePendingTransition( R.anim.slide_up, R.anim.slide_up2);
	}
}
