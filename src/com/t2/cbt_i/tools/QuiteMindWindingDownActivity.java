...
public class QuiteMindWindingDownActivity extends BaseABSActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tools_quitemindwindingdown);
	...
	public void onBackPressed() {
		super.onBackPressed();
		QuiteMindWindingDownActivity.this.overridePendingTransition( R.anim.slide_right, R.anim.slide_right2);
	}
	...
	protected void onResume() {
		cData35a1 = new QuiteMindWindingDownData(this);
		cData35a1.renderData();
	...
	public void getHelp() {			// called to render help screen
		Intent i = new Intent(QuiteMindWindingDownActivity.this, CBTi_Help.class );
		i.putExtra("RID_Img",  R.drawable.buddy_toolshelpwindingdown);
		i.putExtra("RID_Text", R.string.s_35e1);
		QuiteMindWindingDownActivity.this.startActivity(i);
		QuiteMindWindingDownActivity.this.overridePendingTransition( R.anim.slide_up, R.anim.slide_up2);
	}
}
