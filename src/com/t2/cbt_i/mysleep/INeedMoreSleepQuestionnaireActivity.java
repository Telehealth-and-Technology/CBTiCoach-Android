...
public class INeedMoreSleepQuestionnaireActivity extends BaseABSNHActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.mysleep_ineedmoresleepquestionnaire);
		...
		((Button)findViewById(R.id.bDone)).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {		// handle the submit button
				...
				cData23a.saveData();
				Intent i = new Intent(INeedMoreSleepQuestionnaireActivity.this, MySleepMainActivity.class );
				i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				INeedMoreSleepQuestionnaireActivity.this.startActivity(i);
				INeedMoreSleepQuestionnaireActivity.this.overridePendingTransition( R.anim.slide_right, R.anim.slide_right2);
			}
		});
	...
	protected void onResume() {
		cData23c = new INeedMoreSleepQuestionnaireAnswersData(this);
