...
public class SleepDairyEntryActivity extends BaseABSNHActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.mysleep_sleepdairyentry);
			...
			public void onClick(View v) {
				if( (bNew==true) && cData21a.alreadyExists(cData21c.lSDETime))
					...
					if( cData21c.iTSTDailymin < 0 )
						...
						cData21a.saveData();
						cData21c.saveData();
						Intent i = new Intent(SleepDairyEntryActivity.this, SleepDairyEntryResultsActivity.class );
						SleepDairyEntryActivity.this.startActivity(i);
						SleepDairyEntryActivity.this.overridePendingTransition( R.anim.slide_right, R.anim.slide_right2);
	...
	public void onBackPressed() {
		super.onBackPressed();
		cData21a = new SleepDairyData(this);		// this discards all changes
		SleepDairyEntryActivity.this.overridePendingTransition( R.anim.slide_down, R.anim.slide_down2);
	}
	...
	protected void onResume() {
		...
		cData21a = new SleepDairyData(this);
		
		if( bNew == true ) 	{
			cData21c = new SleepDairyEntryData( this );			// this will get a brand new object or one with in progress data in in progress
		}
		else {
