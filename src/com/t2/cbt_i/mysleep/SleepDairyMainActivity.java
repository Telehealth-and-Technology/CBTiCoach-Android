...
public class SleepDairyMainActivity extends BaseABSActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((Button)findViewById(R.id.midRight)).setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {		// handle the about button
				...
				i.putExtra("NEW", true);
				new SleepDairyEntryData(SleepDairyMainActivity.this).deleteData();
				SleepDairyMainActivity.this.startActivity(i);
				SleepDairyMainActivity.this.overridePendingTransition( R.anim.slide_up, R.anim.slide_up2);
			}
		});
	...
	protected void onResume() {
	    ...
	    aa = new ArrayAdapter<SleepDairyEntryData>(this, R.layout.sleepdatarow, cData21a.alSleepDiary);
	    lv.setAdapter(aa);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				SleepDairyMainActivity.this.startActivityForResult(i,1);
				SleepDairyMainActivity.this.overridePendingTransition( R.anim.slide_up, R.anim.slide_up2);
			}
		});
	...
	public void getHelp() {			// called to render help screen
		Intent i = new Intent(SleepDairyMainActivity.this, SleepDairyHelpActivity.class );
		SleepDairyMainActivity.this.startActivity(i);
		SleepDairyMainActivity.this.overridePendingTransition( R.anim.slide_right, R.anim.slide_right2);
	}
}