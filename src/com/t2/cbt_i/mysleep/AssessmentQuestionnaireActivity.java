...
public class AssessmentQuestionnaireActivity extends BaseABSNHActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.mysleep_assessmentquestionnaire);
		...
		((Button)findViewById(R.id.bSubmit)).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {		// handle the submit button
				...
				AssessmentStartData cData31b = new AssessmentStartData(AssessmentQuestionnaireActivity.this);
				cData31b.addEntry(cData31c);
				cData31b.saveData();
				Intent i = new Intent(AssessmentQuestionnaireActivity.this, AssessmentResultsActivity.class );
				AssessmentQuestionnaireActivity.this.startActivity(i);
				AssessmentQuestionnaireActivity.this.overridePendingTransition( R.anim.slide_left, R.anim.slide_left2);
			}
		});
	}
	...
	public void onBackPressed() {
		super.onBackPressed();
		AssessmentQuestionnaireActivity.this.overridePendingTransition( R.anim.slide_right, R.anim.slide_right2);
	}
	...
	private void fetchScreen() {
		...
		getSupportActionBar().setTitle( String.format(getString(R.string.s_ISITitle), cData31c.iQuestion+2) );
