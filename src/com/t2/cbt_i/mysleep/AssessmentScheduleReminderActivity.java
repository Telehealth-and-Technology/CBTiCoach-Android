...
public class AssessmentScheduleReminderActivity extends BaseABSNHActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.mysleep_assessmentschedulereminder);
	...
	public void onBackPressed() {
		super.onBackPressed();
		AssessmentScheduleReminderActivity.this.overridePendingTransition( R.anim.slide_right, R.anim.slide_right2);
	}
