...
public class CBTi_Activity22a extends BaseABSActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {    
		...
		((Button)findViewById(R.id.bUpdatePrescription)).setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {		// handle the update button
				CBTi_Data21a cData21a = new CBTi_Data21a(CBTi_Activity22a.this);
				CBTi_Data23a cData23a = new CBTi_Data23a(CBTi_Activity22a.this);
	...
	protected void onResume() {
		CBTi_Data21a cData21a = new CBTi_Data21a( this );
