/*
* Reminders_BR_UpdateSleepPrescription.java
* Broadcast receiver used to set alarms for the user to update their sleep prescription information
*
...
import com.t2.cbt_i.mysleep.UpdateSleepPrescriptionActivity;

public class Reminders_BR_UpdateSleepPrescription extends BroadcastReceiver
{
	...
	public void onReceive(Context context, Intent intent)
	{
		...
		Intent iTgt = new Intent(context, UpdateSleepPrescriptionActivity.class); // prepare
																					// target
																					// intent
