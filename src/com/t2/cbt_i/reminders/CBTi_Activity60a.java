...
public class CBTi_Activity60a extends CBTi_BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) { 
		...
		setContentView(R.layout.cbti_60a);
		...
		((TextView)findViewById(R.id.tvTopTitle)).setText( R.string.s_Reminders);

		// topLeft Button HOME
		((ImageButton)findViewById(R.id.ibTopLeft)).setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {		// handle the about button
				Intent i = new Intent(CBTi_Activity60a.this, DashActivity.class );
				i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				CBTi_Activity60a.this.startActivity(i);
				CBTi_Activity60a.this.overridePendingTransition( R.anim.slide_right, R.anim.slide_right2);
			}
		});
		...
		((ImageButton)findViewById(R.id.ibTopRight)).setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {		// handle the about button
				Intent i = new Intent(CBTi_Activity60a.this, CBTi_Help.class );
				i.putExtra("RID_Img",  R.drawable.buddy_homereminder);
				i.putExtra("RID_Text", R.string.s_60d);
				CBTi_Activity60a.this.startActivity(i);
				CBTi_Activity60a.this.overridePendingTransition( R.anim.slide_left, R.anim.slide_left2);
			}
		});
		...
		((TextView)findViewById(R.id.tSleepDiaryReminder)).setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				iNextClass = CBTi_ActivityRemBRSleepDiary.class;
		...
		((TextView)findViewById(R.id.tUpdateSleepPrescriptionTime)).setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				iNextClass = CBTi_ActivityRemBRUpdateSleepPrescription.class;
				showDialog(TIME_DIALOG_ID);
			}	
		});
		...
		((TextView)findViewById(R.id.tTakeAssessmentTime)).setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				iNextClass = CBTi_ActivityRemBRTakeAssessment.class;
				showDialog(TIME_DIALOG_ID);
			}	
		});
	...
	private TimePickerDialog.OnTimeSetListener mTimeSetListener = new TimePickerDialog.OnTimeSetListener() {
		...
		public void onTimeSet(android.widget.TimePicker view, int hourOfDay, int minute) {
			if( iNextClass == CBTi_ActivityRemBRSleepDiary.class ) {
				cData60a.iSDRmin = cData60a.timeTo4pm( (hourOfDay*60) + minute );
				((TextView)findViewById(R.id.tSleepDiaryReminder)).setText( cData60a.formattedTimeFrom4pm(cData60a.iSDRmin) );
			}
			else if( iNextClass == CBTi_ActivityRemBRWindDown.class) {
				cData60a.iWDTmin = cData60a.timeTo4pm( (hourOfDay*60) + minute );
				((TextView)findViewById(R.id.tWindDownTimeReminder)).setText( cData60a.formattedTimeFrom4pm(cData60a.iWDTmin) );
			}
			else if( iNextClass == CBTi_ActivityRemBRTakeAssessment.class) {
				cData60a.iTAmin = cData60a.timeTo4pm( (hourOfDay*60) + minute );
				((TextView)findViewById(R.id.tTakeAssessmentTime)).setText( cData60a.formattedTimeFrom4pm(cData60a.iTAmin) );
			}
			else if( iNextClass == CBTi_ActivityRemBRStopCaffeine.class) {
				cData60a.iSCmin = cData60a.timeTo4pm( (hourOfDay*60) + minute );
				((TextView)findViewById(R.id.tStopCaffeineReminder)).setText( cData60a.formattedTimeFrom4pm(cData60a.iSCmin) );
			}
			else if( iNextClass == CBTi_ActivityRemBRWorryTime.class) {
				cData60a.iWTmin = cData60a.timeTo4pm( (hourOfDay*60) + minute );
				((TextView)findViewById(R.id.tWorryTimeReminderTime)).setText( cData60a.formattedTimeFrom4pm(cData60a.iWTmin) );
			}
			else if( iNextClass == CBTi_ActivityRemBRUpdateSleepPrescription.class) {
