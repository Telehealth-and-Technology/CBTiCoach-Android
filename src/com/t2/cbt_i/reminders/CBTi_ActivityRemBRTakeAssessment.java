...
import com.t2.cbt_i.mysleep.CBTi_Activity31b;


public class CBTi_ActivityRemBRTakeAssessment extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		Intent iTgt = new Intent(context, CBTi_Activity31b.class);	// prepare target intent
