...
{
	/**
	 * Sets the selection of the action bar spinner
	 * @param activity
	 * @param position
	 * @param animate
	 */
	public static final void selectSpinnerIfPresent(Activity activity, int position, boolean animate)
	{
		try
		{
			...
			{
				final int id = activity.getResources().getIdentifier("action_bar", "id", "android");
			...
			final Method setSelectionMethod = mTabSpinner.getClass().getSuperclass().getDeclaredMethod("setSelection", Integer.TYPE, Boolean.TYPE);
