...
import com.t2.cbti.dashboard.DashboardActivity;
...
public class SplashActivity extends SherlockFragmentActivity
{
	...
	/**
	 * Records that disclaimer has been accepted and starts the home activity
	 * 
	 * @param v
	 */
	public void onAcceptDisclaimerClick(View v)
	{
		...
		mPrefs.edit().putBoolean(getString(R.string.prf_disclaimer_accepted), mDisclaimerAccepted).commit();
		showHome();
	}

	/**
	 * Records that eula has been accepted and starts the home activity
	 * 
	 * @param v
	 */
	...
	{
		mEulaAccepted = true;
		mPrefs.edit().putBoolean(getString(R.string.prf_eula_accepted), mEulaAccepted).commit();
	 ...
	 * 
	 * @param initial
	 *            Uses to determine fragment transition (True: Open False: Fade)
	 */
