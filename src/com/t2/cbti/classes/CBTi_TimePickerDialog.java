/*
* CBTi_TimePickerDialog.java
* Simple class that overrides the onTimeChanged function to prevent the title for being overridden from inside of it
*
